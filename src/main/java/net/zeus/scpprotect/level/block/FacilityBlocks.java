...
public class FacilityBlocks {
    ...
    public static final RegistryObject<Block> EZ_CONCRETE_STAIRS = registerBlock("entrance_zone_concrete_stairs",
            () -> new StairBlock(() -> FacilityBlocks.EZ_CONCRETE.get().defaultBlockState(), BlockBehaviour.Properties.copy(FacilityBlocks.EZ_CONCRETE.get())));

    public static final RegistryObject<Block> EZ_CONCRETE_SLAB = registerBlock("entrance_zone_concrete_slab",
            () -> new SlabBlock(BlockBehaviour.Properties.copy(FacilityBlocks.EZ_CONCRETE.get())));
    ...
    public static final RegistryObject<Block> FLOOR_CONCRETE_STAIRS = registerBlock("floor_concrete_stairs",
            () -> new StairBlock(() -> FacilityBlocks.FLOOR_CONCRETE.get().defaultBlockState(), BlockBehaviour.Properties.copy(FacilityBlocks.FLOOR_CONCRETE.get())));

    public static final RegistryObject<Block> FLOOR_CONCRETE_SLAB = registerBlock("floor_concrete_slab",
            () -> new SlabBlock(BlockBehaviour.Properties.copy(FacilityBlocks.FLOOR_CONCRETE.get())));
    ...
    public static final RegistryObject<Block> LC_CONCRETE_STAIRS = registerBlock("light_containment_concrete_stairs",
            () -> new StairBlock(() -> FacilityBlocks.LC_CONCRETE.get().defaultBlockState(), BlockBehaviour.Properties.copy(FacilityBlocks.LC_CONCRETE.get())));

    public static final RegistryObject<Block> LC_CONCRETE_SLAB = registerBlock("light_containment_concrete_slab",
            () -> new SlabBlock(BlockBehaviour.Properties.copy(FacilityBlocks.LC_CONCRETE.get())));
    ...
    public static final RegistryObject<Block> MOSAIC_TILE_STAIRS = registerBlock("mosaic_tile_stairs",
            () -> new StairBlock(() -> FacilityBlocks.MOSAIC_TILES.get().defaultBlockState(), BlockBehaviour.Properties.copy(FacilityBlocks.MOSAIC_TILES.get())));

    public static final RegistryObject<Block> MOSAIC_TILE_SLAB = registerBlock("mosaic_tile_slab",
            () -> new SlabBlock(BlockBehaviour.Properties.copy(FacilityBlocks.MOSAIC_TILES.get())));
    ...
    public static final RegistryObject<Block> WHITE_TILES_STAIRS = registerBlock("white_tile_stairs",
            () -> new StairBlock(() -> FacilityBlocks.WHITE_TILES.get().defaultBlockState(), BlockBehaviour.Properties.copy(FacilityBlocks.WHITE_TILES.get())));

    public static final RegistryObject<Block> WHITE_TILES_SLAB = registerBlock("white_tile_slab",
            () -> new SlabBlock(BlockBehaviour.Properties.copy(FacilityBlocks.WHITE_TILES.get())));
    ...
    public static final RegistryObject<Block> METAL_PLATE_STAIRS = registerBlock("metal_plate_stairs",
            () -> new StairBlock(() -> FacilityBlocks.METAL_PLATE.get().defaultBlockState(), BlockBehaviour.Properties.copy(FacilityBlocks.METAL_PLATE.get())));

    public static final RegistryObject<Block> METAL_PLATE_SLAB = registerBlock("metal_plate_slab",
            () -> new SlabBlock(BlockBehaviour.Properties.copy(FacilityBlocks.METAL_PLATE.get())));
    ...
    public static final RegistryObject<Block> METALLIC_PANEL_STAIRS = registerBlock("metallic_panel_stairs",
            () -> new StairBlock(() -> FacilityBlocks.METALLIC_PANELS.get().defaultBlockState(), BlockBehaviour.Properties.copy(FacilityBlocks.METALLIC_PANELS.get())));

    public static final RegistryObject<Block> METALLIC_PANEL_SLAB = registerBlock("metallic_panel_slab",
            () -> new SlabBlock(BlockBehaviour.Properties.copy(FacilityBlocks.METALLIC_PANELS.get())));
    ...
    public static final RegistryObject<Block> REINFORCED_CONCRETE_STAIRS = registerBlock("reinforced_concrete_stairs",
            () -> new StairBlock(() -> FacilityBlocks.REINFORCED_CONCRETE.get().defaultBlockState(), BlockBehaviour.Properties.copy(FacilityBlocks.REINFORCED_CONCRETE.get())));

    public static final RegistryObject<Block> REINFORCED_CONCRETE_SLAB = registerBlock("reinforced_concrete_slab",
            () -> new SlabBlock(BlockBehaviour.Properties.copy(FacilityBlocks.REINFORCED_CONCRETE.get())));
    ...
    public static final RegistryObject<Block> DIRTY_METAL_STAIRS = registerBlock("dirty_metal_stairs",
            () -> new StairBlock(() -> FacilityBlocks.DIRTY_METAL.get().defaultBlockState(), BlockBehaviour.Properties.copy(FacilityBlocks.DIRTY_METAL.get())));
    ...
    public static final RegistryObject<Block> CEMENT_BRICK_SLAB = registerBlock("cement_brick_slab",
            () -> new SlabBlock(BlockBehaviour.Properties.copy(FacilityBlocks.CEMENT_BRICKS.get())));
