...
import net.zeus.scpprotect.level.item.custom.*;
...
public class ModItems {
    ...
    public static final RegistryObject<Item> SCP_173I_SPAWN_EGG = registerEgg("scp_173i_spawn_egg", ModEntity.SCP_173i, new Color(147, 147, 147), new Color(81, 85, 85), SCP.SCPTypes.EUCLID);
