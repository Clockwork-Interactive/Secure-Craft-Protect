...
public class SCPItems {
    ...
    public static final RegistryObject<Item> LEVEL_1_KEYCARD = ITEMS.register("level_1_keycard", () -> new Item(new Item.Properties().stacksTo(1)));
    public static final RegistryObject<Item> LEVEL_2_KEYCARD = ITEMS.register("level_2_keycard", () -> new Item(new Item.Properties().stacksTo(1)));
    public static final RegistryObject<Item> LEVEL_3_KEYCARD = ITEMS.register("level_3_keycard", () -> new Item(new Item.Properties().stacksTo(1)));
