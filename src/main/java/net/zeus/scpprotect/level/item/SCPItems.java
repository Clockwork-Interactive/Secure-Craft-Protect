...
public class SCPItems {
    ...
    public static final RegistryObject<Item> SCP_049_SPAWN_EGG = registerEgg("scp_049_spawn_egg", SCPEntity.SCP_049, new Color(66, 66, 66), new Color(226, 221, 18), SCP.SCPTypes.EUCLID);
